...
public class EtudiantServices {
    ...
    public static Object getEntById(int idEns) {
        return null;
    }

    public static void updateEtd(int id, String nom, Object entById) {
    }

    public static void addEtd(String nom, Etudiant etdById) {
    }
}
